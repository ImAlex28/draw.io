------------------------------------------------------------
-- SCRIPT DE INSERCIÓN MASIVA DE DATOS
------------------------------------------------------------

/*
  1. TARJETA_TAB
     Insertamos varias tarjetas de crédito/débito.
*/
...
/*
  2. LIBRO_TAB
     Insertamos varios libros con sus respectivos ejemplares anidados.
*/
...
/*
  3. EJEMPLARVENTA_TAB
     Insertamos ejemplares destinados a la venta.
*/
...
------------------------------------------------------------
/*
  4. EJEMPLARALQUILER_TAB
     Insertamos ejemplares destinados al alquiler.
*/
...
/*
  5. TRANSACCION_TAB
     Insertamos transacciones usando bloques PL/SQL para obtener el REF de la tarjeta.
*/
DECLARE
...
/*
  6. COMPRA_TAB
     Transacciones de compra (heredan de TRANSACCION_OBJ + Puntos).
*/
DECLARE
  v_tarjeta REF TARJETA_OBJ;
BEGIN
...
/*
  7. ALQUILER_TAB
     Transacciones de alquiler (heredan de TRANSACCION_OBJ + IdAlquiler y FechaInicio).
*/
DECLARE
  v_tarjeta REF TARJETA_OBJ;
BEGIN
...
/*
  9. CLIENTE_TAB
     Insertamos varios clientes. Se usa un subquery para obtener el REF a la dirección.
*/
...
------------------------------------------------------------
/*
 10. ADMINISTRADOR_TAB
     Insertamos administradores utilizando también el REF a dirección.
*/
...
/*
 11. LINEA_COMPRA_TAB
     Insertamos líneas de compra, relacionando ejemplares de venta mediante REF.
*/
DECLARE
...
------------------------------------------------------------
/*
 12. LINEA_ALQUILER_TAB
     Insertamos líneas de alquiler usando REF a ejemplares de alquiler.
*/
DECLARE
...
------------------------------------------------------------
/*
 13. PEDIDO_PROVEEDOR_TAB
     Insertamos varios pedidos a proveedores, usando un VARRAY para las líneas de pedido.
*/
...
/*
 14. PROVEEDOR_TAB
     Insertamos proveedores y en su campo anidado, una colección de pedidos.
*/
...
/*
 15. FACTURA_TAB
     Insertamos facturas que contienen colecciones de transacciones, líneas de compra y de alquiler.
*/
DECLARE
...
BEGIN
  ...
  INSERT INTO FACTURA_TAB VALUES(
    FACTURA_OBJ(
      ...
      5.00,
      TRANSACCIONES_TABTYP(),  -- colección vacía (a poblar si se requiere)
...
/*
 16. CARGO_TAB
     Insertamos cargos asociados a alquileres, utilizando REF a transacciones de alquiler.
*/
DECLARE
