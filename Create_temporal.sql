...
/
/
CREATE OR REPLACE LIBROS_TABTYP AS TABLE OF REF LIBRO_OBJ;
/
...
)NESTED TABLE Lineas_Factura 
        STORE AS LINEAS_NTAB(PRIMARY KEY(NESTED_TABLE_ID,IdLineaFactura));
    NESTED TABLE Transacciones STORE AS TRANSACCIONES_NTAB
;
/
...
CREATE TABLE PROVEEDOR_TAB OF PROVEEDOR_OBJ(
    Id PRIMARY KEY,
    Nombre NOT NULL,
)NESTED TABLE PEDIDOS_PROVEEDOR STORE AS PEDIDOS_PROVEEDOR_NTAB,
...
/
CREATE O REPLACE TYPE PEDIDO_PROVEEDOR_TABTYP 
    AS TABLE OF REF PEDIDO_PROVEEDOR_OBJ;
/
/
