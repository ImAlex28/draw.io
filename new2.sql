...
CREATE OR REPLACE TYPE EJEMPLARESVENTA_NTABTYP AS TABLE OF REF EJEMPLAR_VENTA_OBJ;
/

CREATE OR REPLACE TYPE EJEMPLARESALQUILER_NTABTYP AS TABLE OF REF EJEMPLAR_ALQUILER_OBJ;
/
...
CREATE TABLE EJEMPLAR_VENTA_TAB OF EJEMPLAR_VENTA_OBJ(
    ID PRIMARY KEY
);

CREATE TABLE EJEMPLAR_ALQUILER_TAB OF EJEMPLAR_ALQUILER_OBJ(
    ID PRIMARY KEY
);
